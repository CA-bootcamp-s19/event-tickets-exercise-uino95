...
contract EventTickets {
    ...
    */
    ...
    modifier enoughTickets(uint tickets) { 
    ...
    modifier checkValue(uint tickets) {
        ...
        _;
        uint cost = tickets * TICKET_PRICE;
    ...
    */
    function getRefund () public {
        uint currentTickets = myEvent.buyers[msg.sender];
        require (currentTickets > 0);
        myEvent.sales -= currentTickets;
        myEvent.totalTickets += currentTickets;
        msg.sender.transfer(currentTickets * TICKET_PRICE);
        emit LogGetRefund(msg.sender, currentTickets);
    }
